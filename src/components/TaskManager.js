...
export default function TaskManager() {
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-black border border-gray-600 rounded-xl p-5 shadow-lg">
      <h1 className="text-white text-xl font-bold mb-3">AI Task Manager</h1>
      ...
      <input
        ...
        className="w-full px-3 py-2 rounded bg-gray-800 text-white text-sm border border-gray-700 mb-3"
      />
      ...
      {response && (
        <div className="mt-4 p-3 border border-gray-500 rounded bg-gray-900 text-white text-sm">
